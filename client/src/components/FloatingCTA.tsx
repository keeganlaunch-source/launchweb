...
export default function FloatingCTA() {
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 bg-primary text-primary-foreground p-4 shadow-2xl z-[100] border-t border-black/20">
        <div className="container mx-auto max-w-4xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-center sm:text-left">
            <div className="font-heading text-xl uppercase tracking-wide">Ready To Start?</div>
          </div>

          <Button
            onClick={handleSignUp}
            className="bg-brand-black hover:bg-black/80 text-brand-bone font-medium uppercase tracking-wide px-8 py-3 rounded-none"
          >
            Sign Up Now
          </Button>
        </div>
